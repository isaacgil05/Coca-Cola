...
public class Central extends JFrame implements ActionListener {
    ...
    private JLabel labelLogo, labelBienvenido, labelTitle, labelNombre, labelAPaterno, labelAMaterno, labelDepartamento,
    ...
    public Central() {
        ...
        setTitle("Pantalla Central");
        getContentPane().setBackground(new Color(255, 0, 0));
        setIconImage(new ImageIcon(getClass().getResource("images/icon.png")).getImage());
        Bienve ventanaBienve = new Bienve();
        nombreAdministrador = ventanaBienve.texto;
        ...
        txtNombreTrabajador.setFont(new java.awt.Font("Andale", 1, 14));
        ...
        txtAPaternoTrabajador.setFont(new java.awt.Font("Andale", 1, 14));
        ...
        txtAMaternoTrabajador.setFont(new java.awt.Font("Andale", 1, 14));
        ...
        comboDepartamento.setFont(new java.awt.Font("Andale", 1, 14));
